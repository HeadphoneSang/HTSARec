...
class MultiHeadAttention(nn.Module):
    ...
    def forward(self, input_tensor, attention_mask):
        ...
        # context_layer = self.drop(context_layer)
        hidden_states = self.LayerNorm(context_layer + input_tensor)
...
class FeedForward(nn.Module):
    ...
    def __init__(
        ...
        self.intermediate_act_fn = self.get_hidden_act(hidden_act.lower())
    ...
    def forward(self, inter_hidden_states, intervals_hidden_states, attention_mask, output_all_encoded_layers=True):
        ...
        for layer_module in self.layer:
            ...
            if output_all_encoded_layers:
                all_encoder_layers.append(inter_hidden_states)
